...
def compute_white_tophat(src: ImageObj, p: MorphologyParam) -> ImageObj:
    """Compute White Top-Hat using :py:func:`skimage.morphology.white_tophat`
...
def compute_black_tophat(src: ImageObj, p: MorphologyParam) -> ImageObj:
    """Compute Black Top-Hat using :py:func:`skimage.morphology.black_tophat`
...
def compute_erosion(src: ImageObj, p: MorphologyParam) -> ImageObj:
    """Compute Erosion using :py:func:`skimage.morphology.erosion`
...
def compute_dilation(src: ImageObj, p: MorphologyParam) -> ImageObj:
    """Compute Dilation using :py:func:`skimage.morphology.dilation`
...
def compute_opening(src: ImageObj, p: MorphologyParam) -> ImageObj:
    """Compute morphological opening using :py:func:`skimage.morphology.opening`
...
def compute_closing(src: ImageObj, p: MorphologyParam) -> ImageObj:
    """Compute morphological closing using :py:func:`skimage.morphology.closing`
