...
def xy_fft(
    x: np.ndarray, y: np.ndarray, shift: bool = True, bode: bool = False
    ...
    Args:
        ...
        shift (bool | None): Shift the zero frequency to the center of the spectrum.
            Defaults to True.
        bode (bool | None): Plot magnitude in dB. Defaults to False.
