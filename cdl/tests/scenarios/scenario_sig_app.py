...
def compute_11_operations(panel: SignalPanel | ImagePanel, number: int) -> None:
...
def do_common_operations(panel: SignalPanel | ImagePanel) -> None:
    ...
    compute_11_operations(panel, 2)


def __test_signal_features(
...
def test_scenario_signal() -> None:
    ...
    with cdltest_app_context(save=True) as win:
        ...
        __test_signal_features(win, all_types=True)
        ...
        __test_signal_features(win, all_types=False)
