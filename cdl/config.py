...
PLOTPY_DEFAULTS = {
    ...
    "roi": {  # Annotated shape style for ROI shapes
        # Signals:
        "s/line/style": "SolidLine",
        "s/line/color": ROI_LINE_COLOR,
        "s/line/width": 1,
        "s/sel_line/style": "SolidLine",
        "s/sel_line/color": ROI_SEL_LINE_COLOR,
        "s/sel_line/width": 2,
        "s/fill": ROI_LINE_COLOR,
        "s/shade": 0.15,
        "s/symbol/marker": "Ellipse",
        "s/symbol/size": 7,
        "s/symbol/edgecolor": MAIN_BG_COLOR,
        "s/symbol/facecolor": ROI_LINE_COLOR,
        "s/symbol/alpha": 1.0,
        "s/sel_symbol/marker": "Ellipse",
        "s/sel_symbol/size": 9,
        "s/sel_symbol/edgecolor": MAIN_BG_COLOR,
        "s/sel_symbol/facecolor": ROI_SEL_LINE_COLOR,
        "s/sel_symbol/alpha": 0.9,
        "s/multi/color": "#806060",
        # Images:
        "i/line/style": "DotLine",
        "i/line/color": ROI_LINE_COLOR,
        "i/line/width": 1,
        "i/fill/style": "SolidPattern",
        "i/fill/color": MAIN_BG_COLOR,
        "i/fill/alpha": 0.1,
        "i/symbol/marker": "NoSymbol",
        "i/symbol/size": 5,
        "i/symbol/edgecolor": ROI_LINE_COLOR,
        "i/symbol/facecolor": ROI_LINE_COLOR,
        "i/symbol/alpha": 0.6,
        "i/sel_line/style": "DotLine",
        "i/sel_line/color": "#0000ff",
        "i/sel_line/width": 1,
        "i/sel_fill/style": "SolidPattern",
        "i/sel_fill/color": MAIN_BG_COLOR,
        "i/sel_fill/alpha": 0.1,
        "i/sel_symbol/marker": "Rect",
        "i/sel_symbol/size": 8,
        "i/sel_symbol/edgecolor": "#0000aa",
        "i/sel_symbol/facecolor": "#0000ff",
        "i/sel_symbol/alpha": 0.7,
    },
}
