...
from cdl.core.gui import actionhandler, objectlist, plotitemlist, roieditor
...
from cdl.core.io.signal import read_signal, write_signal
...
class AbstractPanel(QW.QSplitter, metaclass=AbstractPanelMeta):
    """Object defining CobraDataLab panel interface, based on a vertical QSplitter widget
