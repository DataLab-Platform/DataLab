...
class SignalProcessor(BaseProcessor[SignalROI]):
    ...
    def compute_power(self, param: cps.PowerParam | None = None) -> None:
        ...
        self.compute_1_to_1(cps.compute_power, param, cps.PowerParam, title="Power")
    ...
    def compute_peak_detection(
        ...
        if edit:
            ...
            if exec_dialog(dlg):
                ...
                return
        self.compute_1_to_1(cps.compute_peak_detection, param)

    @qt_try_except()
    def compute_reverse_x(self) -> None:
        """Reverse X axis with :py:func:`cdl.computation.signal.compute_reverse_x`"""
        self.compute_1_to_1(cps.compute_reverse_x, title=_("Reverse X axis"))
    ...
    def compute_derivative(self) -> None:
        ...
        self.compute_1_to_1(cps.compute_derivative, title=_("Derivative"))

    @qt_try_except()
    def compute_integral(self) -> None:
        """Compute integral with :py:func:`cdl.computation.signal.compute_integral`"""
        self.compute_1_to_1(cps.compute_integral, title=_("Integral"))
    ...
    def compute_clip(self, param: cpb.ClipParam | None = None) -> None:
        ...
        self.compute_1_to_1(cps.compute_clip, param, cpb.ClipParam, title=_("Clipping"))
    ...
    def compute_offset_correction(self, param: ROI1DParam | None = None) -> None:
        ...
        if param is None:
            ...
            if exec_dialog(dlg):
                ...
                return
        self.compute_1_to_1(cps.compute_offset_correction, param)
    ...
    def compute_wiener(self) -> None:
        ...
        self.compute_1_to_1(cps.compute_wiener, title=_("Wiener filter"))
    ...
    def __freq_filter(
        ...
        self.compute_1_to_1(cps.compute_filter, param, title=title, edit=edit)
    ...
    def compute_fft(self, param: cdl.param.FFTParam | None = None) -> None:
        ...
        self.compute_1_to_1(cps.compute_fft, param, title=_("FFT"), edit=False)
    ...
    def compute_ifft(self, param: cdl.param.FFTParam | None = None) -> None:
        ...
        if param is None:
            param = cpb.FFTParam.create(shift=Conf.proc.fft_shift_enabled.get())
        self.compute_1_to_1(cps.compute_ifft, param, title=_("iFFT"), edit=False)
    ...
    def compute_phase_spectrum(self) -> None:
        ...
        self.compute_1_to_1(cps.compute_phase_spectrum, title=_("Phase spectrum"))
    ...
    def compute_psd(self, param: cdl.param.SpectrumParam | None = None) -> None:
        ...
        self.compute_1_to_1(
            cps.compute_psd, param, cdl.param.SpectrumParam, title=_("PSD")
        )
    ...
    def compute_resampling(self, param: cdl.param.ResamplingParam | None = None):
        ...
        self.compute_1_to_1(cps.compute_resampling, param, title=title, edit=edit)
    ...
    def compute_contrast(self) -> dict[str, ResultProperties]:
        ...
        return self.compute_1_to_0(cps.compute_contrast, title=_("Contrast"))
    ...
    def compute_x_at_minmax(self) -> dict[str, ResultProperties]:
        ...
        return self.compute_1_to_0(cps.compute_x_at_minmax, title="X @ min,max")
    ...
    def compute_x_at_y(
        ...
        if param is None:
            ...
            if exec_dialog(dlg):
                ...
                return
        return self.compute_1_to_0(cps.compute_x_at_y, param)
    ...
    def compute_y_at_x(
        ...
        if param is None:
            ...
            if exec_dialog(dlg):
                ...
                return
        return self.compute_1_to_0(cps.compute_y_at_x, param)
    ...
    def compute_bandwidth_3db(self) -> None:
        ...
        self.compute_1_to_0(cps.compute_bandwidth_3db, title=_("Bandwidth"))
