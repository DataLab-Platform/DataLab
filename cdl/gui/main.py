...
The :mod:`cdl.gui.main` module provides the main window of the
DataLab (CDL) project.
...
from cdl.baseproxy import AbstractCDLControl
...
from cdl.gui.actionhandler import ActionCategory
from cdl.gui.docks import DockablePlotWidget
from cdl.gui.h5io import H5InputOutput
from cdl.gui.panel import base, image, macro, signal
...
if TYPE_CHECKING:
    ...
    from cdl.gui.panel.base import AbstractPanel, BaseDataPanel
    from cdl.gui.panel.image import ImagePanel
    from cdl.gui.panel.macro import MacroPanel
