...
The :mod:`cdl.gui.profiledialog` module provides the profile extraction dialog.
...
class ProfileExtractionDialog(PlotDialog):
    ...
    def __init__(
        ...
        | sigima_.param.SegmentProfileParam
        | sigima_.param.AverageProfileParam,
    ...
    def reset_to_initial(self) -> None:
        ...
        self.button_box.button(QW.QDialogButtonBox.Ok).setEnabled(False)
        if self.mode == "line":
            self.param = sigima_.param.LineProfileParam()
        elif self.mode == "segment":
            self.param = sigima_.param.SegmentProfileParam()
        else:
            self.param = sigima_.param.AverageProfileParam()
        plot = self.get_plot()
        if self.shape is not None:
