...
"""
.. Signal panel (see parent package :mod:`cdl.gui.panel`)
"""
...
from cdl.gui.actionhandler import SignalActionHandler
from cdl.gui.newobject import NewSignalParam, create_signal_gui
