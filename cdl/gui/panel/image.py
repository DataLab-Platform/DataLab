...
"""
.. Image panel (see parent package :mod:`cdl.gui.panel`)
"""
...
from cdl.gui.actionhandler import ImageActionHandler
from cdl.gui.newobject import create_image_gui
...
from sigima_ import ImageDatatypes, ImageObj, ImageROI, NewImageParam
