...
def test_history_app():
    ...
    with datalab_test_app_context() as win:
        ...
        # (this also clears the history panel)
        win.reset_all()
        assert len(history) == 0
        ...
        assert creation_entry.title == "New signal"
        ...
        assert all_titles[0] == "New signal"
        ...
        # ``delete_actions`` itself opens a confirmation dialog; we exercise the
