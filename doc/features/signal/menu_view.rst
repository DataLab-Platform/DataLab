...
When this option is enabled, only the first selected signal is shown in the plot
view. This can be useful when you have many signals selected and you want to
