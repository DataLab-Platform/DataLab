...
import cdlapp.core.computation.base
from cdlapp.config import APP_NAME, Conf, _
from cdlapp.core.gui import actionhandler, objectmodel, objectview, roieditor
from cdlapp.core.io.base import IOAction
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from cdlapp.core.gui import ObjItf
    from cdlapp.core.gui.main import CDLMainWindow
    from cdlapp.core.gui.plothandler import BasePlotHandler
    from cdlapp.core.gui.processor.image import ImageProcessor
    from cdlapp.core.gui.processor.signal import SignalProcessor
    ...
    from cdlapp.core.model.image import ImageObj, NewImageParam
    from cdlapp.core.model.signal import NewSignalParam, SignalObj
...
class AbstractPanel(QW.QSplitter, metaclass=AbstractPanelMeta):
    ...
    Each object must implement ``cdlapp.core.gui.ObjItf`` interface
    """
...
class BaseDataPanel(AbstractPanel):
    ...
    ) -> cdlapp.core.computation.base.ROIDataParam:
