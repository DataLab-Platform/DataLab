...
from cdlapp import __docurl__, __homeurl__, __supporturl__, __version__, env
from cdlapp.config import (
    APP_DESC,
    APP_NAME,
    DATAPATH,
    DEBUG,
...
from cdlapp.core.baseproxy import AbstractCDLControl
from cdlapp.core.gui.actionhandler import ActionCategory
from cdlapp.core.gui.docks import DockablePlotWidget
from cdlapp.core.gui.h5io import H5InputOutput
from cdlapp.core.gui.panel import base, image, macro, signal
...
from cdlapp.core.remote import RemoteServer
from cdlapp.env import execenv
from cdlapp.plugins import PluginRegistry, discover_plugins
from cdlapp.utils import dephash
from cdlapp.utils import qthelpers as qth
from cdlapp.utils.misc import go_to_error
from cdlapp.widgets import instconfviewer, logviewer, status

if TYPE_CHECKING:  # pragma: no cover
    from cdlapp.core.gui.panel.base import AbstractPanel, BaseDataPanel
    from cdlapp.core.gui.panel.image import ImagePanel
    from cdlapp.core.gui.panel.macro import MacroPanel
    from cdlapp.core.gui.panel.signal import SignalPanel
    from cdlapp.plugins import PluginBase
...
class CDLMainWindow(QW.QMainWindow, AbstractCDLControl, metaclass=CDLMainWindowMeta):
    ...
    def __setup_console(self) -> None:
        ...
        msg = (
            ...
            "---------------------------\n"
            "You can access the main window with the 'cdlapp' variable.\n"
            "Example:\n"
            "  o = cdlapp.get_object()  # returns currently selected object\n"
