...
class SignalProcessor(BaseProcessor):
    ...
    def compute_peak_detection(
        self, param: cdlapp.param.PeakDetectionParam | None = None
    ) -> None:
    ...
    def compute_normalize(
        self, param: cdlapp.param.NormalizeYParam | None = None
    ) -> None:
        """Normalize data"""
        self.compute_11(
    ...
    def compute_calibration(
        self, param: cdlapp.param.XYCalibrateParam | None = None
    ) -> None:
    ...
    @qt_try_except()
    def compute_polyfit(
        self, param: cdlapp.param.PolynomialFitParam | None = None
    ) -> None:
    ...
    # ------Signal Computing
    @qt_try_except()
    def compute_fwhm(self, param: cdlapp.param.FWHMParam | None = None) -> None:
        """Compute FWHM"""
        self.compute_10(
