...
import cdlapp.core.computation.image as cpi
import cdlapp.core.computation.image.detection as cpi_det
import cdlapp.core.computation.image.edges as cpi_edg
import cdlapp.core.computation.image.exposure as cpi_exp
import cdlapp.core.computation.image.morphology as cpi_mor
import cdlapp.core.computation.image.restoration as cpi_res
import cdlapp.param
from cdlapp.algorithms.image import distance_matrix
from cdlapp.config import APP_NAME, Conf, _
...
class ImageProcessor(BaseProcessor):
    ...
    @qt_try_except()
    def compute_logp1(self, param: cdlapp.param.LogP1Param | None = None) -> None:
        """Compute base 10 logarithm"""
        self.compute_11(cpi.compute_logp1, param, cpi.LogP1Param, title="Log10")

    @qt_try_except()
    def compute_rotate(self, param: cdlapp.param.RotateParam | None = None) -> None:
    ...
    @qt_try_except()
    def distribute_on_grid(self, param: cdlapp.param.GridParam | None = None) -> None:
    ...
    @qt_try_except()
    def compute_resize(self, param: cdlapp.param.ResizeParam | None = None) -> None:
        """Resize image"""
    ...
    @qt_try_except()
    def compute_binning(self, param: cdlapp.param.BinningParam | None = None) -> None:
        """Binning image"""
        edit = param is None
    ...
    def compute_roi_extraction(
        self, param: cdlapp.param.ROIDataParam | None = None
    ) -> None:
    ...
    def compute_flatfield(
        ...
        param: cdlapp.core.computation.param.FlatFieldParam | None = None,
    ) -> None:
    ...
    def compute_calibration(
        self, param: cdlapp.param.ZCalibrateParam | None = None
    ) -> None:
    ...
    @qt_try_except()
    def compute_fft(self, param: cdlapp.param.FFTParam | None = None) -> None:
        """Compute FFT"""
        if param is None:
    ...
    @qt_try_except()
    def compute_ifft(self, param: cdlapp.param.FFTParam | None = None) -> None:
        "Compute iFFT" ""
        if param is None:
            param = cpb.FFTParam.create(shift=Conf.proc.fft_shift_enabled.get())
    ...
    def compute_butterworth(
        self, param: cdlapp.param.ButterworthParam | None = None
    ) -> None:
    ...
    def compute_adjust_gamma(
        self, param: cdlapp.param.AdjustGammaParam | None = None
    ) -> None:
    ...
    @qt_try_except()
    def compute_adjust_log(
        self, param: cdlapp.param.AdjustLogParam | None = None
    ) -> None:
    ...
    def compute_adjust_sigmoid(
        self,
        param: cdlapp.param.AdjustSigmoidParam | None = None,
    ) -> None:
    ...
    def compute_rescale_intensity(
        self,
        param: cdlapp.param.RescaleIntensityParam | None = None,
    ) -> None:
    ...
    def compute_equalize_hist(
        self, param: cdlapp.param.EqualizeHistParam | None = None
    ) -> None:
    ...
    def compute_equalize_adapthist(
        self,
        param: cdlapp.param.EqualizeAdaptHistParam | None = None,
    ) -> None:
    ...
    @qt_try_except()
    def compute_denoise_tv(
        self, param: cdlapp.param.DenoiseTVParam | None = None
    ) -> None:
    ...
    def compute_denoise_bilateral(
        self,
        param: cdlapp.param.DenoiseBilateralParam | None = None,
    ) -> None:
    ...
    def compute_denoise_wavelet(
        self,
        param: cdlapp.param.DenoiseWaveletParam | None = None,
    ) -> None:
    ...
    def compute_denoise_tophat(
        self, param: cdlapp.param.MorphologyParam | None = None
    ) -> None:
    ...
    @qt_try_except()
    def compute_canny(self, param: cdlapp.param.CannyParam | None = None) -> None:
    ...
    def compute_peak_detection(
        self, param: cdlapp.param.Peak2DDetectionParam | None = None
    ) -> None:
    ...
    def compute_contour_shape(
        self, param: cdlapp.param.ContourShapeParam | None = None
    ) -> None:
    ...
    def compute_hough_circle_peaks(
        self, param: cdlapp.param.HoughCircleParam | None = None
    ) -> None:
    ...
    @qt_try_except()
    def compute_blob_dog(self, param: cdlapp.param.BlobDOGParam | None = None) -> None:
    ...
    @qt_try_except()
    def compute_blob_doh(self, param: cdlapp.param.BlobDOHParam | None = None) -> None:
    ...
    @qt_try_except()
    def compute_blob_log(self, param: cdlapp.param.BlobLOGParam | None = None) -> None:
    ...
    def compute_blob_opencv(
        self,
        param: cdlapp.param.BlobOpenCVParam | None = None,
    ) -> None:
